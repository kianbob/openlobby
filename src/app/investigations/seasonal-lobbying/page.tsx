...
export default function SeasonalLobbyingPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "Article", headline: "Washington's Busiest Quarter: The Hidden Calendar of Lobbying", author: { "@type": "Organization", name: "OpenLobby", url: "https://www.openlobby.us" }, publisher: { "@type": "Organization", name: "OpenLobby" }, datePublished: "2026-02-24", description: "Lobbying follows a predictable seasonal rhythm. Q4 is the busiest quarter with $9.9B in income.", mainEntityOfPage: "https://www.openlobby.us/investigations/seasonal-lobbying" }) }} />
      <Breadcrumbs items={[
