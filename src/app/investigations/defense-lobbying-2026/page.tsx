...
export default function DefenseLobbying2026Page() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [ { "@type": "Question", "name": "How much are defense contractors spending on lobbying in 2026?", "acceptedAnswer": { "@type": "Answer", "text": "Defense contractor lobbying hit $190M+ in H1 2026 and is on pace to exceed $380 million for the full year — a 45% increase over 2025 and the highest since the Iraq War." } }, { "@type": "Question", "name": "Which defense companies are the top lobbying spenders?", "acceptedAnswer": { "@type": "Answer", "text": "Lockheed Martin leads with $28.5M in H1 2026 (+52% YoY), followed by RTX/Raytheon ($24.8M), Boeing ($22.1M), and Northrop Grumman ($19.6M)." } }, { "@type": "Question", "name": "How has the Iran war affected defense lobbying?", "acceptedAnswer": { "@type": "Answer", "text": "The Pentagon's $200B supplemental request and $916B FY2026 defense budget have created a lobbying gold rush. Over 780 former Pentagon officials are now active defense lobbyists." } }, { "@type": "Question", "name": "What role does AI play in defense lobbying?", "acceptedAnswer": { "@type": "Answer", "text": "AI weapons systems represent a new frontier in defense lobbying. Companies are competing for autonomous weapons, drone swarm, and cyber warfare contracts, with AI defense spending growing rapidly." } } ] }) }} />
      <Breadcrumbs items={[
