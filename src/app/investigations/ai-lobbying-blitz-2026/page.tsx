...
export default function AILobbyingBlitz2026Page() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [ { "@type": "Question", "name": "How much did Meta spend on AI lobbying in California?", "acceptedAnswer": { "@type": "Answer", "text": "Meta spent $4.6 million on lobbying in California alone, focused on AI regulation, open-source AI protections, and data center expansion." } }, { "@type": "Question", "name": "Which AI companies are spending the most on lobbying in 2026?", "acceptedAnswer": { "@type": "Answer", "text": "Google, Meta, Microsoft, and Amazon lead in AI lobbying spending. OpenAI and Anthropic have dramatically increased their lobbying presence, with OpenAI's spend up 180% and Anthropic's up 210% year-over-year." } }, { "@type": "Question", "name": "Are AI companies flying congressional staffers on luxury trips?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. According to Sludge reporting, AI lobbyists have arranged luxury trips for congressional staffers to learn about AI technology, raising ethics questions about influence tactics." } }, { "@type": "Question", "name": "What are tech companies lobbying Congress about on AI?", "acceptedAnswer": { "@type": "Answer", "text": "Key lobbying issues include AI safety frameworks, liability shields, federal preemption of state AI laws, open-source AI protections, data center permitting, AI export controls, and government AI procurement standards." } } ] }) }} />
      <Breadcrumbs items={[
