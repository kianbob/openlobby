...
export default function BigPharmaLobbyingPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [ { "@type": "Question", "name": "How much has the pharmaceutical industry spent on lobbying?", "acceptedAnswer": { "@type": "Answer", "text": "The pharmaceutical and healthcare industry has spent over $452 million on lobbying Congress, making it the single largest lobbying sector in America." } }, { "@type": "Question", "name": "Why does Big Pharma spend so much on lobbying?", "acceptedAnswer": { "@type": "Answer", "text": "Pharmaceutical companies lobby to protect drug pricing power, fight Medicare price negotiation, extend patent protections, influence FDA regulatory processes, and shape healthcare legislation." } }, { "@type": "Question", "name": "Which pharmaceutical companies lobby the most?", "acceptedAnswer": { "@type": "Answer", "text": "PhRMA (the industry trade group) is the top spender, followed by individual companies like Pfizer, AbbVie, Johnson & Johnson, Eli Lilly, and Merck." } }, { "@type": "Question", "name": "Does pharma lobbying affect drug prices?", "acceptedAnswer": { "@type": "Answer", "text": "Evidence suggests a strong connection. The pharmaceutical industry has successfully lobbied against drug price controls for decades, and U.S. drug prices remain the highest in the developed world." } } ] }) }} />
      <Breadcrumbs items={[
      ...
      <section className="mt-10 mb-8 not-prose">
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 mb-6">
          <h3 className="text-sm font-bold text-emerald-800 mb-1">💊 See How Lobbying Affects Prices</h3>
          <p className="text-sm text-emerald-700">
            Pharma lobbying doesn&apos;t happen in a vacuum — it shapes the prices you pay. Explore hospital and insurance pricing transparency data at{' '}
            <a href="https://clearprices.thedataproject.ai" target="_blank" rel="noopener noreferrer" className="underline font-semibold text-emerald-800 hover:text-emerald-900">ClearPrices →</a>
          </p>
        </div>
