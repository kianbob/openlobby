  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: 'Independent data journalism platform tracking federal lobbying. 726,000+ filings, $37.7B in spending, 23,545 lobbyists, 37,994 clients (2018-2026).',
        sameAs: [],
      },
      {
        '@type': 'Dataset',
        name: 'Federal Lobbying Disclosure Database',
        description: 'Comprehensive database of federal lobbying disclosures from Senate LDA filings, covering 2018-2026. Includes $37.7B in spending across 726,000+ filings from 37,994 clients and 23,545 lobbyists.',
        url: 'https://www.openlobby.us',
